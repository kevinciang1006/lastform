  ...
  return (
    <section className="grid grid-cols-1 gap-14 bg-ink px-10 py-[76px] text-chalk lg:grid-cols-[1fr_1.15fr]">
      <div className="flex flex-col gap-[18px]">
        <p className="font-mono text-meta tracking-eyebrow text-slate">FIELD NOTE — FROM THE WORKSHOP</p>
      ...
      <div className="flex flex-col gap-4 pt-[34px]">
        ...
        <Link
          ...
          className="mt-2 w-fit border-b border-cobalt pb-1 font-mono text-[11px] tracking-wide text-cobalt hover:border-chalk hover:text-chalk"
        >
          READ THE FIELD NOTE →
        </Link>
      </div>
