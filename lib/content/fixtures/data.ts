import type { Collection, JournalPost } from '@/lib/content/schema';
import { paragraph, pullQuote } from './portable-text';

export { PRODUCTS } from './data.products';
// Single definition, shared with the Sanity adapter's fallback for an
// unseeded settings singleton — see lib/content/defaults.ts.
export { DEFAULT_SITE_SETTINGS as SITE_SETTINGS } from '@/lib/content/defaults';
